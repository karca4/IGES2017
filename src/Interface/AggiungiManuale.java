...
public class AggiungiManuale extends JFrame{
	...
	private String stat="Call inserisciManuale(?,?,?,?,?,?,?,?,?,?,?)";
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(bt.equals(btConferma)){
				...
				try{
					...
					preparedStatement.setString(9,(String)cbTipo.getSelectedItem());
...
//					System.out.println(preparedStatement.execute());
	...
	public AggiungiManuale() {
		setTitle("Aggiungi manuale");
		setSize(500,500);
	...
	private void initComponent(){
		...
		cbTipo.addItem("cucina");
		cbTipo.addItem("utente");
